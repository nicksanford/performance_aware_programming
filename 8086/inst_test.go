...
`),
		...
		// 		0b10100011, 0b00001111, 0b00000000},
		// 	expectedOutFile: []byte(`bits 16
		...
		// },
		{
			...
			inFile: []byte{
				...
				//    s=0 8 bit immediate
				//    w=0 8 bit register
				0b10000000, 0b00000111, 0b00100010,
				// 17. add word [bp + si + 1000], 29
				...
				//    reg=000
				//    rm 010
				0b10000011, 0b10000010, 0b11101000, 0b00000011, 0b00011101, 0b00000011, 0b01000110, 0b00000000,
